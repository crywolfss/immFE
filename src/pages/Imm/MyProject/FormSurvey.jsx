        ...
        <div className='mx-auto max-w-7xl p-6 lg:px-8'>
            <form>
                ...
                <div className="flex items-center justify-center mt-16 mb-16">
                    <button className="bg-[#2A64F6] hover:bg-[#2A64F6] text-white font-semibold py-2 px-4 rounded-3xl focus:outline-none focus:shadow-outline" type="button" onClick={handleSubmit}>
