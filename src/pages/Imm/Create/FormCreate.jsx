...
export const FormCreate = () => {
  ...
  useEffect(() => {
    const fetchTags = async () => {
      try {
        await axios.get('http://127.0.0.1:8000/api/tag')
        .then(response => {
    ...
    const fetchSdgs = async () => {
      try {
        const response = await axios.get('http://127.0.0.1:8000/api/sdg');
    ...
    const fetchIndicators = async () => {
      try {
        const response = await axios.get('http://127.0.0.1:8000/api/indicator');
    ...
    const fetchMetrics = async () => {
      try {
        const response = await axios.get('http://127.0.0.1:8000/api/metric');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:8000/api/project', data, {
        headers: {
              ...
              <div className='mt-3'>
                ...
                <div className='mb-4'>
                  ...
                  <select 
                    ...
                    onChange={handleChange}
                  >
                    <option value="" disabled>Pilih Matrik</option>
                    {metrics.map((metric) => (
